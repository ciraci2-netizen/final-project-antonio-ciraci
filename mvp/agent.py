...
LANG = {
    "EN": {
        ...
        "submit": "Analyse My Listing →", "your_score": "YOUR SCORE", "beats": "beats",
    ...
    "IT": {
        ...
        "how_text": "Inserisci i dati del tuo listing — BerlinHostAIQ ti posizionera vs i competitor e generera raccomandazioni personalizzate.",
...
def run_streamlit():
    ...
    <style>
        ...
        .section-header { font-family:'DM Sans',sans-serif; font-size:1rem; font-weight:600; color:var(--cyan); letter-spacing:0.05em; margin:2rem 0 1rem; display:flex; align-items:center; gap:10px; }
    ...
    with st.sidebar:
        ...
        {T["filters"].upper()}<br>
        <span style="color:#00D4FF; font-size:1rem;">{len(df):,}</span> listings<br>
        ...
        RANKING<br>Price 40% · Reviews 40%<br>Demand 20%
        </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value">&#8364;{filtered['price'].median():.0f}<span style="font-size:1rem;color:#8899AA">{T["night"]}</span></div>
        </div>
        <div class="kpi-card">
