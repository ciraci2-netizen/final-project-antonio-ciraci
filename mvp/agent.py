...
def run_streamlit():
    ...
    <style>
        ...
        /* ===== ENHANCED UI - Professional Upgrade ===== */                /* ---- Global Smooth Transitions ---- */        * { transition: background-color 0.2s ease, color 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease; }        /* ---- KPI Cards: Glassmorphism + deeper shadows ---- */        .kpi-card {            background: linear-gradient(135deg, rgba(19,33,64,0.95) 0%, rgba(15,31,56,0.98) 100%) !important;            border: 1px solid rgba(0,212,255,0.25) !important;            border-radius: 16px !important;            box-shadow: 0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(0,212,255,0.08), inset 0 1px 0 rgba(255,255,255,0.05) !important;            backdrop-filter: blur(12px) !important;            -webkit-backdrop-filter: blur(12px) !important;            position: relative !important;            overflow: hidden !important;        }        .kpi-card:hover {            border-color: rgba(0,212,255,0.5) !important;            box-shadow: 0 12px 40px rgba(0,0,0,0.5), 0 0 20px rgba(0,212,255,0.12) !important;            transform: translateY(-2px) !important;        }        /* ---- Sidebar improvements ---- */        section[data-testid="stSidebar"] {            background: linear-gradient(180deg, #0A1628 0%, #0D1B30 100%) !important;            border-right: 1px solid rgba(0,212,255,0.15) !important;            box-shadow: 4px 0 24px rgba(0,0,0,0.3) !important;        }        section[data-testid="stSidebar"] .stSelectbox > div > div {            background: rgba(19,33,64,0.8) !important;            border: 1px solid rgba(0,212,255,0.2) !important;            border-radius: 8px !important;        }        section[data-testid="stSidebar"] .stSelectbox > div > div:hover {            border-color: rgba(0,212,255,0.5) !important;            box-shadow: 0 0 10px rgba(0,212,255,0.1) !important;        }        /* ---- Section header gradient ---- */        .section-header {            background: linear-gradient(90deg, #00D4FF 0%, #0099BB 100%) !important;            -webkit-background-clip: text !important;            -webkit-text-fill-color: transparent !important;            background-clip: text !important;        }        /* ---- Table rows styled ---- */        .stDataFrame table { border-radius: 12px !important; overflow: hidden !important; }        .stDataFrame thead tr th {            background: linear-gradient(135deg, #0F1F38 0%, #132140 100%) !important;            color: #00D4FF !important;            font-family: 'Space Mono', monospace !important;            font-size: 0.72rem !important;            font-weight: 700 !important;            letter-spacing: 0.1em !important;            text-transform: uppercase !important;            padding: 14px 16px !important;            border-bottom: 2px solid rgba(0,212,255,0.3) !important;        }        .stDataFrame tbody tr:nth-child(even) { background: rgba(0,212,255,0.03) !important; }        .stDataFrame tbody tr:hover {            background: rgba(0,212,255,0.08) !important;            box-shadow: inset 3px 0 0 #00D4FF !important;        }        .stDataFrame tbody tr td {            padding: 12px 16px !important;            border-bottom: 1px solid rgba(0,212,255,0.06) !important;            color: #C8D8E8 !important;        }        /* ---- Expander improvements ---- */        .streamlit-expanderHeader {            background: linear-gradient(135deg, rgba(19,33,64,0.9) 0%, rgba(15,31,56,0.95) 100%) !important;            border: 1px solid rgba(0,212,255,0.2) !important;            border-radius: 10px !important;        }        .streamlit-expanderHeader:hover {            border-color: rgba(0,212,255,0.45) !important;            background: rgba(0,212,255,0.06) !important;        }        /* ---- Scrollbar custom ---- */        ::-webkit-scrollbar { width: 6px; height: 6px; }        ::-webkit-scrollbar-track { background: rgba(10,22,40,0.5); }        ::-webkit-scrollbar-thumb { background: rgba(0,212,255,0.3); border-radius: 3px; }        ::-webkit-scrollbar-thumb:hover { background: rgba(0,212,255,0.55); }        /* ---- Footer enhancement ---- */        .footer {            background: linear-gradient(90deg, rgba(19,33,64,0.6) 0%, rgba(15,31,56,0.6) 100%) !important;            border: 1px solid rgba(0,212,255,0.1) !important;            border-radius: 10px !important;            backdrop-filter: blur(8px) !important;            margin-top: 2rem !important;        }        /* ---- Metric value glow ---- */        .kpi-value { text-shadow: 0 0 20px rgba(0,212,255,0.3) !important; }        /* ---- Button improvements ---- */        .stButton > button {            background: linear-gradient(135deg, rgba(0,212,255,0.15) 0%, rgba(0,153,187,0.1) 100%) !important;            border: 1px solid rgba(0,212,255,0.4) !important;            border-radius: 8px !important;            color: #00D4FF !important;            font-weight: 700 !important;        }        .stButton > button:hover {            background: linear-gradient(135deg, rgba(0,212,255,0.25) 0%, rgba(0,153,187,0.2) 100%) !important;            border-color: rgba(0,212,255,0.7) !important;            box-shadow: 0 4px 16px rgba(0,212,255,0.2) !important;            transform: translateY(-1px) !important;        }        /* ===== END ENHANCED UI ===== */    </style>
